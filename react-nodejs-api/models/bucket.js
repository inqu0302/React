 ...
 * NoSQL 은 도큐먼트 방식으로 데이터를 저장하고 관리하는 DB이다
 * RDBMS에는 초기에 반드시 데이터를 저장할 공간을 만들고
 * 데이터의 구조를 선언하여 table등을 생성해야 한다
 *
 * NoSQL은 저장공간만 선언하고
 * 데이터는 언제든지 필요한 구조로 Document를 만들어 저장한다
 * NoSQL Doument = JSON 데이터
 *
 * 보통 DBMS에서는 구조적인 방법으로 데이터를 관리하는 것이 편리할때가 있다
 * mongoose 를 사용하면 NoSQL 을 마치 Schema 가 있는 RDBMS의 모양처럼 사용할 수 있다
 */
